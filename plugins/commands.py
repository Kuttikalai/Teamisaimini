...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('⚡ DISCUSSION ⚡', url='https://t.me/+O1_2wAq0V4c4M2I1')
            ],
            [
                InlineKeyboardButton('⚡ CHANNEL ⚡', url=f"https://t.me/Teamisaimini"),
            ],
            [
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ CHANNEL ⚡', url='https://t.me/Teamisaimini'),
            InlineKeyboardButton('⚡ DISUSSION ⚡', url='https://t.me/+O1_2wAq0V4c4M2I1')
            ],[
            InlineKeyboardButton('♻️ HΞLᎮ ♻️', callback_data='help'),
            InlineKeyboardButton('♻️ ΛBOUT ♻️', callback_data='about')
        ]]
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('JOIN NOW', url='https://t.me/shapeofdindiguldiscussion') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
